...
// include: /var/folders/nl/s__8mn4932jbf59hq57rjlr40000gn/T/tmpau7ew61m.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'drawww.data';
      var REMOTE_PACKAGE_BASE = 'drawww.data';
...
Module['FS_createPath']("/shaders", "point", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_drawww.data');

      };
      Module['addRunDependency']('datafile_drawww.data');
    ...
    loadPackage({"files": [{"filename": "/shaders/point/point.frag", "start": 0, "end": 92}, {"filename": "/shaders/point/point.vert", "start": 92, "end": 254}, {"filename": "/shaders/point/point_webgl2.frag", "start": 254, "end": 369}, {"filename": "/shaders/point/point_webgl2.vert", "start": 369, "end": 509}], "remote_package_size": 509});

  })();

// end include: /var/folders/nl/s__8mn4932jbf59hq57rjlr40000gn/T/tmpau7ew61m.js
// include: /var/folders/nl/s__8mn4932jbf59hq57rjlr40000gn/T/tmpd3fo86ch.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /var/folders/nl/s__8mn4932jbf59hq57rjlr40000gn/T/tmpd3fo86ch.js
// include: /var/folders/nl/s__8mn4932jbf59hq57rjlr40000gn/T/tmpzelaq_cf.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /var/folders/nl/s__8mn4932jbf59hq57rjlr40000gn/T/tmpzelaq_cf.js
